...
$active_users = $conn->query("
    SELECT
        ...
        COUNT(DISTINCT CASE WHEN last_login >= DATE_SUB(NOW(), INTERVAL 1 DAY) THEN user_id END) as daily_active,
        COUNT(DISTINCT CASE WHEN last_login >= DATE_SUB(NOW(), INTERVAL 7 DAY) THEN user_id END) as weekly_active,
...
$most_active = $conn->prepare("
    SELECT u.user_id, u.username, u.full_name, u.total_xp, u.current_level, u.last_login,
