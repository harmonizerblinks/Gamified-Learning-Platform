...
$page_title = "Edit Course - " . SITE_NAME;
        ...
        <div class="row">
            ...
            <main class="col-md-9 ms-sm-auto col-lg-10 px-md-4 py-4">
                ...
                <div class="d-flex justify-content-between align-items-center mb-4">
                    <h1><i class="fas fa-graduation-cap me-2"></i>Edit Course</h1>
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-md-4 mb-3">
                                            ...
                                            <select class="form-select" id="subject_id" name="subject_id" required>
                                                ...
                                                <?php foreach ($subjects as $subject): ?>
                                                    <option value="<?php echo $subject['subject_id']; ?>" <?php echo $subject['subject_id'] == $course['subject_id'] ? 'selected' : ''; ?>>
                                        ...
                                        <div class="col-md-6 mb-3">
                                            ...
                                            <select class="form-select" id="difficulty" name="difficulty">
                                                ...
                                                <option value="expert" <?php echo $course['difficulty'] == 'expert' ? 'selected' : ''; ?>>Expert</option>
                                            </select>
                                        </div>

                                        <div class="col-md-6 mb-3">
                                            <label for="required_level" class="form-label">Required User Level</label>
                                            <input type="number" class="form-control" id="required_level" name="required_level" min="1" max="10" value="<?php echo $course['required_level']; ?>">
                                        </div>

                                        <div class="col-md-6 mb-3">
                                            <label for="estimated_duration" class="form-label">Estimated Duration (minutes)</label>
                                            <input type="number" class="form-control" id="estimated_duration" name="estimated_duration" value="<?php echo $course['estimated_duration']; ?>">
                                        </div>

                                        <div class="col-md-6 mb-3">
                                            <label for="xp_reward" class="form-label">XP Reward</label>
                                            <input type="number" class="form-control" id="xp_reward" name="xp_reward" value="<?php echo $course['xp_reward']; ?>">
                                        </div>
                                        ...
                                        <div class="col-12 mb-3">
                                            ...
                                            <?php if ($course['thumbnail']): ?>
                                                <div class="mb-2">
                                                    <img src="<?php echo UPLOAD_URL; ?>thumbnails/<?php echo $course['thumbnail']; ?>" alt="Current thumbnail" style="max-width: 200px;">
                                                </div>
                                            <?php endif; ?>
                                        ...
                                        <div class="col-12 mb-3">
                                            <div class="form-check">
                                                <input class="form-check-input" type="checkbox" id="is_published" name="is_published" <?php echo $course['is_published'] ? 'checked' : ''; ?>>
